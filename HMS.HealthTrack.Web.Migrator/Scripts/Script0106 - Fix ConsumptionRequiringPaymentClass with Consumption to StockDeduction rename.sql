/****** Object:  View [Inventory].[ConsumptionRequiringPaymentClass]    Script Date: 27/08/2015 5:16:03 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT        c.StockDeductionId, c.StockId, c.ConsumedOn, c.ConsumedBy, c.DeletedOn, c.QuantityConsumed, c.Status, p.ProductId, p.SPC, p.Description, p.Manufacturer, p.PrimarySupplier, p.SecondarySupplier, 
                         p.IsConsignment, p.MinimumOrder, p.OrderMultiple, p.ReorderThreshold, p.TargetStockLevel, pat.patient_ID, pat.firstName, pat.surname, pat.dob, pat.mrn, 
...
FROM            Inventory.StockDeduction AS c INNER JOIN
