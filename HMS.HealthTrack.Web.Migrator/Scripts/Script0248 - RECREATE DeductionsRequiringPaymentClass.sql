/****** Object:  View [Inventory].[DeductionRequiringPaymentClass]    Script Date: 10-May-16 2:35:43 PM ******/
...
SELECT        sa.StockAdjustmentId, s.StockId, sa.AdjustedOn, sa.AdjustedBy, sa.DeletedOn, sa.Quantity, sa.Status	, p.ProductId, p.SPC, p.Description, p.Manufacturer, p.PrimarySupplier, p.SecondarySupplier, 
