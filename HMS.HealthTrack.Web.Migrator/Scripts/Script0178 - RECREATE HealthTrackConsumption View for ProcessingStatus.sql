/****** Object:  View [Inventory].[HealthTrackConsumption]    Script Date: 08-Dec-15 2:39:37 PM ******/
...
SELECT        u.invUsed_ID AS UsedId, m.Inv_ID AS ProductId, m.Inv_SPC AS SPC, m.Inv_LPC AS LPC, m.Inv_UPN AS ScanCode, m.Inv_Description AS Name,u.LOTNO as LotNumber, u.invUsed_SerialNo AS SerialNumber, 
			  u.invUsed_Qty AS Quantity, RebateCode, u.invUsed_Location AS Location,l.name as LocationName, ISNULL(
                         ...
                         m.Inv_BuyCurrencyRate AS BuyCurrencyRate, u.deleted, u.deletionDate, u.deletionUser, u.dateLastModified, u.userLastModified, u.dateCreated, u.userCreated, cnm.ProcessingStatus, cnm.ProcessingStatusMessage
						 ,cnm.Reported,cnm.ReportedBy,cnm.ReportedOn
