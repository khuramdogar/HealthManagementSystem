/****** Object:  View [Inventory].[ConsumptionRequiringPaymentClass]    Script Date: 03/05/2015 14:54:56 ******/
SET ANSI_NULLS ON
GO
...
SELECT        c.ConsumptionId, c.StockId, c.ConsumedOn, c.ConsumedBy, c.DeletedOn, c.QuantityConsumed, c.Status, p.ProductId, p.SPC, p.Description, p.Manufacturer, p.PrimarySupplier, p.SecondarySupplier, 
                         p.IsConsignment, p.MinimumOrder, p.RecommendedOrder, p.OrderMultiple, p.ReorderThreshold, p.TargetStockLevel, p.OrderableUnits, pat.patient_ID, pat.firstName, pat.surname, 
