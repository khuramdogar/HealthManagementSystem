/****** Object:  View [Inventory].[NegativeStock]    Script Date: 09-May-16 4:53:34 PM ******/
...
WHERE us.IsNegative = 1 AND (c.MostRecent IS NULL OR s.StockId > c.MostRecent) AND (st.StockTakeDate IS NULL OR st.StockTakeDate < c.MostRecentDate) AND sa.DeletedOn IS NULL AND sa.IsPositive = 0
