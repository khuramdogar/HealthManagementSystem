...
namespace HMS.HealthTrack.Api.Test.OrderingIntegration
{
    ...
    public class OraclePurchaseOrderTests
    {
        ...
        {
            var purchaseOrder = new OraclePurchaseOrder(ValidInput);

            Assert.AreEqual(1, purchaseOrder.FeederSystemRequisitionNumber);
        }
        ...
        public void Constructor_ValidInput_FeederSystemLineNumberIsAssigned()
        {
            ...
            Assert.AreEqual(2, purchaseOrder.FeederSystemLineNumber);
        }
        ...
        public void Constructor_TooFewArguments_ThrowsException()
        {
            try
            {
                var purchaseOrder = new OraclePurchaseOrder("1|2|3|4|5|dist|");
            }
        ...
        public void Constructor_InvalidFmisRequisitionNumber_ThrowsException()
        {
            try
            {
                var purchaseOrder = new OraclePurchaseOrder("1|2|x|4|5|dist|6|supplier|hospital|12.34|7|8|");
            }
            catch (ArgumentException ex)
            {
                Assert.AreEqual(
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|20|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|32|4|5|dist|6|supplier|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|41|5|dist|6|supplier|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|52|dist|6|supplier|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist1|6|supplier|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist|62|supplier|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier2|hospital|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital4|12.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|15.34|7|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|74|8|");
        ...
        {
            var a = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|8|");
            var b = new OraclePurchaseOrder("1|2|3|4|5|dist|6|supplier|hospital|12.34|7|87|");
